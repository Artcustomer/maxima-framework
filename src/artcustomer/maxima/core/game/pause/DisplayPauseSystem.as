...
package artcustomer.maxima.core.game.pause {
	...
	/**
	 * DisplayPauseSystem : TODO...
	 * 
	 * @author David Massenot
	 */
	public class DisplayPauseSystem extends AbstractEngineDisplayObject {
		private static const FULL_CLASS_NAME:String = 'artcustomer.maxima.core.view::DisplayPauseSystem';
		 ...
		 */
		public function DisplayPauseSystem(aName:String) {
			super();
